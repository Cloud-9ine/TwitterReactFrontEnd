...
const Nav = ({popup, onclick, userInfo}) => {
  return (
    <nav>
      <div className="links">
        <More show={popup} onclick={onclick}/>
        <Link to="/home" className="nav__item row">
          <div className='rows logo'>
            <i className="bi bi-twitter logo__twitter"></i>
          </div>
        </Link>

        <Link to="/home" className="nav__item row">
          <div className="rows row highlight">
            ...
            <span className="collapse-item">Home</span>
          </div>
        </Link>
        <Link to="/explore" className="nav__item row">
          <div className="rows row highlight">
            <svg viewBox="0 0 24 24" className="icon">
              <g>
            ...
            <span className="collapse-item">Explore</span>
          </div>
        </Link>
        <Link to="/notifications" className="nav__item row">
          <div className="rows row highlight">
            <div>
              <svg viewBox="0 0 24 24" className="icon">
                <g>
            ...
            <span className="collapse-item">Notifications</span>
          </div>
        </Link>
        <Link to="/messages" className="nav__item row">
          <div className="rows row highlight">
            <svg viewBox="0 0 24 24" className="icon">
              <g>
            ...
            <span className="collapse-item">Messages</span>
          </div>
        </Link>
        <Link to="/profile" className="nav__item row">
          <div className="rows row highlight">
            <svg viewBox="0 0 24 24" className="icon">
              <g>
            ...
            <span className="collapse-item">Profile</span>
          </div>
        </Link>
        <div to="" className="nav__item row" onClick={onclick}>
          <div className="rows row highlight">
            <svg viewBox="0 0 24 24" className="icon">
              <g>
            ...
            <span className="collapse-item">More</span>
          </div>
        </div>
        <div className="nav__item row">
          <button>
            <svg viewBox="0 0 24 24" className="icon tweet_icon">
              <g>
      ...
      <div className="profile nav__item row highlight">
        <img src={userInfo.profile_image} alt="" />
        <div className="collapse-item">
          <h5 className="full-name">{userInfo.fullname}</h5>
          <div className="twitter__handle">{userInfo.handle}</div>
        </div>
        <i className="bi bi-three-dots collapse-item"></i>
      </div>
    </nav>
  );
}
